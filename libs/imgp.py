...
async def profil_yap(user, dbuser):
    ...
    ts3 = font2.render(f"Level {dbuser.level} - {dbuser.xp-dbuser.pre_xp()} / {dbuser.next_xp()-dbuser.pre_xp()}", True, (255, 255, 255))
    ts4 = font2.render(f"Level {dbuser.level} - {dbuser.xp-dbuser.pre_xp()} / {dbuser.next_xp()-dbuser.pre_xp()}", True, (0, 0, 0))
    ...
    xp_orani = (dbuser.xp - dbuser.pre_xp()) / (dbuser.next_xp() - dbuser.pre_xp())
